...
public class StayScheduleRepository : BaseRepository, IStayScheduleRepository
{
    ...
    {
        var query = $@"Insert Into stayschedule(stay_schedule_id,room_id,guest_id,check_in,check_out)VALUES(@StayScheduleId,@RoomId,@GuestId,@CheckIn,@CheckOut) RETURNING *";
