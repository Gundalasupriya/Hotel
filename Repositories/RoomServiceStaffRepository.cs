...

{
    ...
    {
        var query = $@"Insert Into roomservicestaff(staff_id,staff_name,staff_address,contact_number,gender)VALUES(@StaffId,@StaffName,@StaffAddress,@ContactNumber,@Gender) RETURNING *";
